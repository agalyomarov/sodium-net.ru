...
<head>
	...
	<title><?php echo e($settings->sitename); ?> - Панель управления</title>
	<meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
	<link href="<?php echo e(asset('assets/images/favicon.png')); ?>" rel="shortcut icon" type="image/png">
	<link href="<?php echo e(asset('cp/css/jquery.dataTables.min.css')); ?>" rel="stylesheet" type="text/css">
	<link href="<?php echo e(asset('cp/css/jquery.toast.min.css')); ?>" rel="stylesheet" type="text/css">
	<link href="<?php echo e(asset('cp/css/style.css')); ?>" rel="stylesheet" type="text/css">
</head>
...
<body>
				...
				<div class="nav-wrap">
                    <div class="mobile-only-brand pull-left">
                        <div class="nav-header pull-left">
                            <div class="logo-wrap">
                                <a href="/admin">
                                    <img class="brand-img" src="/cp/img/logo.png" alt="brand"/>
                                    <span class="brand-text"><img  src="/cp/img/brand.png" alt="brand"/></span>
                                </a>
                            </div>
                        </div>	
                    ...
                    <div class="mobile-only-nav pull-right">
                        <ul class="nav navbar-right top-nav pull-right">
                            <li class="auth-drp">
                                <a class="pr-0"><img src="<?php echo e($u->avatar); ?>" alt="<?php echo e($u->username); ?>" class="user-auth-img img-circle"/></a>
                            </li>
                        </ul>
                    </div>	
				</div>
		...
		<div class="page-wrapper">
			...
			<footer class="footer pl-30 pr-30">
				<div class="container">
					<div class="row">
						<div class="col-sm-6">
							<p>2018 &copy; <?php echo e($settings->domain); ?>. Панель управления</p>
						</div>
					</div>
				</div>
			</footer>
	...
	<!-- JavaScript -->
    <script src="<?php echo e(asset('cp/js/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('cp/js/bootstrap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('cp/js/jquery.dataTables.min.js')); ?>"></script>
    <script src="<?php echo e(asset('cp/js/jquery.slimscroll.js')); ?>"></script>
    <script src="<?php echo e(asset('cp/js/jquery.toast.min.js')); ?>"></script>
    <script src="<?php echo e(asset('cp/js/init.js')); ?>"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/socket.io/2.1.1/socket.io.js"></script>
    <script src="<?php echo e(asset('cp/js/adminPost.js')); ?>"></script>
