...
<div class="cont-a">
	<div class="rules">
		...
		<ol class="decimal-list">
			<li>Данный документ является договором на использование сервиса <?php echo e($settings->sitename); ?>. Ниже приведены правила и условия использования Сервиса. Пожалуйста, внимательно ознакомьтесь с ними.</li>
			<li>Сервисом могут пользоваться лица старше 18 лет.</li>
			<li>Игра "<?php echo e($settings->sitename); ?>" - беспроигрышная онлайн игра принадлежащая организатору и находящаяся по адресу в сети интернет https://<?php echo e($settings->domain); ?>. Организатором предоставляются услуги пользователю по организации его развлечения, досуга и отдыха.</li>
			<li>Организаторы беспроигрышной онлайн игры <?php echo e($settings->sitename); ?> никого насильно не заставляют проводить свой досуг на этом проекте.</li>
			<li>Администрация Сервиса оставляет за собой право вносить изменения в текст данных Правил. Пользователь самостоятельно отслеживает изменения Правил, размещенных по адресу https://<?php echo e($settings->domain); ?>/rules.</li>
		</ol>
