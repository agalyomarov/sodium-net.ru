                    ...
                    <table id="datable_1" class="table table-hover display  pb-30 dataTable" role="grid" aria-describedby="datable_1_info">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$code->id}}</td>
                                @if($code->user_id)
                                <td><img src="{{\App\User::getUser($code->user_id)->avatar}}" style="width:50px;border-radius:50%;margin-right:10px;vertical-align:middle;"> <a href="/admin/user/{{$code->user_id}}">{{\App\User::getUser($code->user_id)->username}}</a></td>
                                @else
