                    ...
                    <table id="datable_1" class="table table-hover display  pb-30 dataTable" role="grid" aria-describedby="datable_1_info">
                        <thead>
                            <tr>
                                ...
                                <th>Система</th>
                                <th>Кошелек</th>
                               @if($u->superadmin) <th>Действия</th> @endif
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                              ...
                              @if($u->superadmin)  <td class="text-center"><a href="/admin/withdraw/{{$withdraw['id']}}" class="btn btn-primary btn-rounded btn-xs">Отправить</a> <a href="/admin/return/{{$withdraw['id']}}" class="btn btn-danger btn-rounded btn-xs">Вернуть</a></td>
                            </tr>
                            @endif
                            @endforeach
                        </tbody>
