						...
						<div class="panel panel-default border-panel card-view">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body row">
									<div class="text-center">
										<div class="col-md-12 mb-5" style="font-size: 20px;"><span style="color: #22af47;">{{$profit_jackpot}}</span>руб.</div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-sm-12 col-xs-12">
						<div class="panel panel-default border-panel card-view">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body row">
									<div class="text-center">
										<div class="col-md-12 mb-5" style="font-size: 20px;"><span style="color: #22af47;">{{$profit_pvp}}</span>руб.</div>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-sm-12 col-xs-12">
						<div class="panel panel-default border-panel card-view">
							<div class="panel-heading">
								<div class="text-center">
									<h6 class="panel-title txt-dark">Комиссия Battle</h6>
								</div>
								<div class="clearfix"></div>
							</div>
							<div class="panel-wrapper collapse in">
								<div class="panel-body row">
									<div class="text-center">
										<div class="col-md-12 mb-5" style="font-size: 20px;"><span style="color: #22af47;">{{$profit_battle}}</span>руб.</div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-sm-12 col-xs-12">
						<div class="panel panel-default border-panel card-view">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body row">
									<div class="text-center">
										<div class="col-md-12 mb-5" style="font-size: 20px;"><span style="color: #22af47;">{{$profit_double}}</span>руб.</div>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-sm-12 col-xs-12">
						<div class="panel panel-default border-panel card-view">
							<div class="panel-heading">
								<div class="text-center">
									<h6 class="panel-title txt-dark">Профит Dice</h6>
								</div>
								<div class="clearfix"></div>
							</div>
							<div class="panel-wrapper collapse in">
								<div class="panel-body row">
									<div class="text-center">
										<div class="col-md-12 mb-5" style="font-size: 20px;"><span style="color: #22af47;">{{$profit_dice}}</span>руб.</div>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-sm-12 col-xs-12">
						<div class="panel panel-default border-panel card-view">
							<div class="panel-heading">
								<div class="text-center">
									<h6 class="panel-title txt-dark">Профит Crash</h6>
								</div>
								<div class="clearfix"></div>
							</div>
							<div class="panel-wrapper collapse in">
								<div class="panel-body row">
									<div class="text-center">
										<div class="col-md-12 mb-5" style="font-size: 20px;"><span style="color: #22af47;">{{$profit_crash}}</span>руб.</div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-sm-12 col-xs-12">
						<div class="panel panel-default border-panel card-view">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body row">
									<div class="text-center">
										<div class="col-md-12 mb-5" style="font-size: 20px;"><span class="text-success">{{ $profit }}</span>руб.</div>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-sm-12 col-xs-12">
						<div class="panel panel-default border-panel card-view">
							<div class="panel-heading">
								<div class="text-center">
									<h6 class="panel-title txt-dark">Ставки дабл - Таймер: <span id="dtime">{{$settings->roulette_timer}}</span></h6>
								</div>
								<div class="clearfix"></div>
							</div>
							<div class="panel-wrapper collapse in">
								<div class="panel-body row">
									<div class="text-center">
										<div class="col-md-12 mb-5" style="font-size: 20px;"><span class="text-danger" id="dlred">{{$dlbet['red']}}</span> | <span class="text-success" id="dlgreen">{{$dlbet['green']}}</span> | <span id="dlblack">{{$dlbet['black']}}</span></div>
									</div>
								</div>
							</div>
						</div>
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody id="chance_small">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $user['chance'] }}%/{{ $user['sum'] }}PT</td>
                                        <td><button class="btn btn-primary btn-outline btn-xs" onclick="gotRoulette('{{ $user['room'] }}', {{ $user['id'] }})"><i class="fa fa-check"></i></button></td>
                                    </tr>
                                    @endforeach @endif
                                </tbody>
                            </table>
...
<div class="row">
	...
	<div class="col-sm-4">
		<div class="panel panel-default border-panel card-view">
			<div class="panel-heading">
				<div class="text-center">
					<h6 class="panel-title txt-dark">Подкрутка (Краш)</h6>
				</div>
				<div class="clearfix"></div>
			</div>
			<div class="panel-wrapper collapse in">
				<div class="panel-body">
					<div class="text-center mb-5">
						<div class="form-group">
							<input type="text" class="form-control" id="mul_adm" placeholder="Множитель (х.хх)">
						</div>
						<button class="btn btn-primary btn-rounded gotCrash">Подкрутить</button>
					</div>
				</div>
			</div>
		</div>
        ...
        <div class="row">
            <div class="col-sm-12 col-xs-12">
                <div class="panel panel-default border-panel card-view">
                    <div class="panel-heading">
                        <div class="text-center">
                            <h6 class="panel-title txt-dark">Ставка в Dice</h6>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="panel-wrapper collapse in">
						<div class="panel-body">
							...
							<div class="form-group">
								<label class="control-label mb-10 text-left">Сумма</label>
								<input type="text" class="form-control" placeholder="0" id="sum_dice" value="10">
							</div>
							<div class="form-group">
								<label class="control-label mb-10 text-left">Процент</label>
								<input type="text" class="form-control" placeholder="0" id="perc_dice" value="50">
							</div>
							<div class="text-center mt-10">
								<button class="btn btn-success betDice">Поставить</button>
							</div>
						</div>
					</div>
                </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-xs-12">
                <div class="panel panel-default border-panel card-view">
                    ...
                    <div class="panel-wrapper collapse in" style="{{ $u->superadmin ? 'height: 646px;' : 'height: 498px;' }} overflow-x: hidden;">
                        <div class="panel-body row pa-0">
                            <table class="table table-hover mb-0">
                                <thead>
                                    <tr>
